...
const projectsData = [
  {
    ...
    theme: 'lightning',
    emoji: '🪄',
    description: 'A browser extension for applying high-end Liquid Glass UI effects to any web component with interactive rendering filters. Features real-time parameter tweaking and automatic CSS injection for seamless web integration. Built to eliminate the need for heavy graphical assets by generating dynamic, high-performance glassmorphism structures directly inside the DOM.',
  ...
  },
  {
    ...
    theme: 'fire',
    emoji: '🔍',
    description: 'A full-stack AI-powered application that seamlessly scans and analyzes website technology stacks using OpenRouter API. It provides deep architectural insights into framework choices, backend infrastructure, and frontend rendering bottlenecks. The intuitive dashboard offers comprehensive comparative analytics, helping developer teams make highly informed architectural decisions.',
  ...
  },
  {
    ...
    theme: 'water',
    emoji: '🛡️',
    description: 'Python based Code Vulnerability Scanner that automatically detects and resolves vulnerabilities using intelligent static analysis. The system generates extensive security reports with exact script line-number context and powerful one-click auto-patching capabilities. It seamlessly integrates directly into CI/CD pipelines to ensure enterprise-grade repository safety before main branch deployment.',
  ...
  },
  {
    ...
    theme: 'wind',
    emoji: '🎙️',
    description: 'A RAG-enabled production-ready Voice Assistant using gemma-3-4b-it model, built for high-performance and seamless voice interaction. It leverages advanced dynamic vector retrieval to provide unique context-aware, hyper-accurate verbal responses from vast document knowledge libraries. The ultra-low latency backend architecture ensures a completely natural conversational flow, accurately mirroring real human assistance.',
